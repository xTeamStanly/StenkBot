const commitMessages = [
    ...
    `Fix the fixes`,
    `Fixed Bug`,
    `Fixed a bug cause friend said to`,
    ...
    `Gross hack because friend doesn't know how to code`,
    ...
    `Landed.`,
    `LAST time, friend, /dev/urandom IS NOT a variable name generator...`,
    `LOL!`,
    ...
    `This is the last time we let friends commit ascii porn in the comments.`,
    ...
    `Working on WIP`,
    `Wubbalubbadubdub!`,
    `friend broke the regex, lame`,
    `friend made me do it`,
    `friend rebase plx?`,
    `friend sucks`,
    `FRIEND SUCKS`,
    `FRIEND, WE WENT OVER THIS. C++ IO SUCKS.`,
    `FRIEND, WE WENT OVER THIS. EXPANDTAB.`,
    `Yep, friend was right on this one.`,
