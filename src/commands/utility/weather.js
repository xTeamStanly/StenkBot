        ...
        if (err.response && err.response.status == 404) {
            ...
            await message.channel.createMessage({
                ...
                embed: {
                    ...
                    description: 'Lokacija nije pronađena, ali je zato keširana tako da nema svrhe ponovo tražiti ovu lokaciju. Za dodatne informacije pogledajte info same komande.',
                    thumbnail: { url: 'https://i.imgur.com/qxpds3J.png' }
                }
            });
            return;
